...
import evolution_colab_phase751

try:
    from simplifier_phase751 import simplify_genome
    HAS_SIMPLIFIER = True
except ImportError:
    print("⚠️  simplifier_phase751.py missing. Compression will be skipped.")
...
def run_5bit_adder_phase75():
    ...
    cfg = evolution_colab_phase751.BitwiseConfig(
    ...
    best_ind_raw = evolution_colab_phase751.evolve_phase75(
    ...
    if best_ind_raw:
        ...
        best_ind_str = evolution_colab_phase751.convert_to_string_format(best_ind_raw, n_in)
        vhdl = vhdl_generator_1.generate_vhdl_code(best_ind_str, n_in, n_out)
        with open("evolved_5bit_adder_phase751.vhd", "w") as f:
            f.write(vhdl)
        print("✅ VHDL Exported.")
