...
# - Starts small to solve easy bits fast.
# - Collects unique circuits in Novelty Mode.
# - Injects them into Secondary Accuracy Mode to break stagnation.
    ...
    try:
        for gen in range(cfg.generations):
            ...
            # 2. End Novelty -> Secondary Accuracy
                ...
                evolution_mode = "ACCURACY"
                novelty_archive = []
                # RESET STAGNATION TO GIVE IT A CHANCE
                stagnation_counter = max(0, cfg.backtrack_threshold - 300)
