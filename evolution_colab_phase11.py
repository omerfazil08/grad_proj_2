%%writefile /content/grad_proj/evolution_colab_phase11.py
import random
...
def compute_fitnesses_parallel(population, num_inputs, num_outputs, inputs_set, targets_set, cfg):
    if len(population) == 0:
        return []
...
# --- Main Evolutionary Loop (HSS + parallel) ---
